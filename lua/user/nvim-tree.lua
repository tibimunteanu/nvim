...
-- NOTE: some options are not yet migrated to lua so we have to set them in vim
vim.cmd([[
let g:nvim_tree_window_picker_chars='hl12345678'
...
" some other good arrows for folders: 
