...
local normal = {
  ...
  U           = map("Go to window top",           "H"),
  I           = map("Go to window center",        "M"),
  M           = map("Go to window bottom",        "L"),
  ...
  ["<leader>"] = {
    ...
    m         = map("Disable number column",      ":set nonumber<CR>"),
    M         = map("Enable number column",       ":set number<CR>"),
    q         = map("Close quickfix window",      ":ccl<CR>"),
